...
## Web Component Design & Naming:
  ...
  - `ElementalWebComponentMixin`, for injecting common services or dependencies (like loading a template and appending it to the dom or exposing it to be programmatically adjusted); Can also be in charge of caching it's slots, slotted content, whatever needed.
